...
function Footer() {
  return (
    ...
    >
      ...
      >
        <div className="flex justify-center items-center md:col-span-2 lg:col-span-1 lg:col-start-2 ml-1">
        ...
        <div className="flex justify-center space-x-8 md:ml-auto cursor:pointer hover:underline">
          <p>Privacy</p>
          <p>Terms</p>
          <p>Settings</p>
        </div>
